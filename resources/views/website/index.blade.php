                ...
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <div class="d-flex align-items-center">
                      <img src="{{ $testimoial->get_image_url() }}" class="testimonial-img flex-shrink-0" alt="">
                      <div>
                        <h3>{{ $testimoial->name }}</h3>
                        <h4>{{ $testimoial->title }}</h4>
                        <div class="stars">
                          @for ($i=0;$i< $testimoial->rate;$i++)
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img src="{{ $team->get_image_url() }}" class="img-fluid" alt="">
              <h4>{{ $team->name }}</h4>
